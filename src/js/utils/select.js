...
export class Select {
            ...
            const select = target.closest('.select')
                ...
                : document.querySelector(
                      `.${this.classes.sel}[data-sel-id="${
                          target.closest(this.getClass(this.classes.HAS_LIST)).dataset.selectId
                      }"]`
                  );
    ...
    closeGroup(group, select) {
        ...
        const selections = selGroup.querySelectorAll(
            `${this.getClass(this.classes.SELECT)}${this.getClass(this.classes.IS_OPENED)}`
        );
    ...
    getValue(select, relativeSel) {
        ...
        if (relativeSel.hasAttribute('data-sel-search')) {
            ...
            return `<button type="button" class="${this.classes.TITLE}"><span ${
                attr ? attr : ''
            } class="${this.classes.VALUE} ${attrClass ? attrClass : ''}"><span class="${
